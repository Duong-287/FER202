          ...
          <Card className="shadow-lg p-4 border-0" style={{ backgroundColor: '#f8f9fa' }}>
            ...
            <h2 className="text-center mb-4">Login</h2>
              <div className="text-center mb-4">
                <Button variant="light" style={ {borderColor: 'rgb(220,220,220)'}} className="w-100"  onClick={handleLoginWithGoogle}>
                  <img 
                    src="goo.jpeg" 
                    width="20" 
                    height="20" 
              ...
              <div className="text-center mt-3">
                <Link to="/fogotPassword" className="d-block">Forgot Password?</Link>
